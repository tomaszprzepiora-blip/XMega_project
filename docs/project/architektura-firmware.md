...
- Petla glowna obsluguje: linie z ESP, dotyk (przyciski albo - gdy dotyk jest w belce statusu przez ~1.4s - otwarcie menu), auto-wygaszanie podswietlenia po 10s bezczynnosci.
...
- `xmega_ui.c` rysuje ekran, sprawdza dotyk po wspolrzednych (po kalibracji z `touch_resistive.c`) i aktualizuje stan. Przyciski 1-5 (Salon..Noc) przelaczaja sie (wlacz/wylacz) miedzy dotykami; 6-9 (All Off/Temp 1/Temp 2/Sync) to akcje jednorazowe bez trwalego stanu.
...
Format tekstowych wiadomosci XMEGA <-> ESP.
